//
//  PASAppFeedbackCopy.swift
//  PASKitLifecycle
//
//  Alert copy for presentAppFeedback — injectable so apps can localise or
//  personalise it without PASKit growing a string catalog.
//

import Foundation

/// Alert copy for `presentAppFeedback`, per stage. Strings are shown
/// verbatim; build them with `String(localized:bundle:)` and app vocabulary
/// at the call site.
public struct PASAppFeedbackCopy: Equatable, Sendable {
    ...
    public init(
        initialTitle: String = "Got a moment to share feedback?",
        initialMessage: String? = nil,
        initialAccept: String = "Yes, Continue!",
        askLater: String = "Ask Later",
        neverAsk: String = "Never Ask Me Again",
        followUpTitle: String = "Got a moment to share feedback?",
    ...
    public static let standard = PASAppFeedbackCopy()
}
